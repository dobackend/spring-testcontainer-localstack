...
import net.roodt.springtestcontainers.authz.user.UserRepository;
import net.roodt.springtestcontainers.authz.user.event.UserCreatedEvent;
import net.roodt.springtestcontainers.authz.user.event.UserDeletedEvent;
